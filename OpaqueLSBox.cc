...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new OpaqueLSBoxDetectorConstruction());
  ...
  runManager->SetUserInitialization(new OpaqueLSBoxActionInitialization());
